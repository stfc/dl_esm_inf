# -*- coding: utf-8 -*-
#
# dl_esm_inf documentation build configuration file, created by
...
htmlhelp_basename = 'dl_esm_inf_doc'
...
latex_documents = [
    ('index', 'dl_esm_inf.tex', u'dl_esm_inf Documentation',
     u'Rupert Ford, Joerg Henrichs and Andrew Porter', 'manual'),
]
...
man_pages = [
    ('index', 'dl_esm_inf', u'dl_esm_inf Documentation',
     [u'Rupert Ford, Joerg Henrichs and Andrew Porter'], 1)
]
...
texinfo_documents = [
    ('index', 'dl_esm_inf', u'dl_esm_inf Documentation',
     u'Rupert Ford, Joerg Henrichs and Andrew Porter', 'dl_esm_inf',
     'A basic infrastructure library supporting earth-system Finite-Difference models.',
     'Miscellaneous'),
]
